...
microKernelModule.factory('$agent', function($rootScope, $fws, $auth) {
	...
	function getDisplayInfo(type, id){
		...
		switch (type){
			...
			case "agent":
				data = [
					...
					{name:"info", caption:"Information", displayType:"info", contents:[
						{name:"", displayType:"chart", displayId:"redis1@duov6.com:requests", caption:"Request Calculation"},
			...
			case "config":
				data = [
					{name:"commands", caption:"Tenant Configuration", displayType:"config", contents:[]}
				];
				break;
